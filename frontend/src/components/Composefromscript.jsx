...
const ComposePage = ({ onNavigate }) => {
  ...
  const handleGenerateAudio = () => {
    if (title && content && selectedVoice && selectedCategory) {
      ...
      <div className="pt-32 px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          ...
          <div className="bg-white/5 backdrop-blur-lg border border-white/20 rounded-3xl p-8">
            ...
            {/* Content Textarea */}
            <div className="mb-8">
              <label className="block text-white/80 text-xl font-light mb-2">Content</label>
              <div className="text-white/60 text-sm mb-2">{content.length}/500 characters</div>
